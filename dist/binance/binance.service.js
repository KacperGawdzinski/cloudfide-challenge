...
let BinanceService = class BinanceService {
    constructor(httpService, tradeModel) {
        this.httpService = httpService;
        this.tradeModel = tradeModel;
    }
    async fetchRecentTransactions(symbol) {
        const response = await (0, rxjs_1.lastValueFrom)(this.httpService.get("https://api.binance.com/api/v3/trades", {
            params: {
                symbol,
            },
        }));
...
exports.BinanceService = BinanceService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)(trade_schema_1.Trade.name)),
